...
import { closeCampaign } from "../../store/actions/products.action";
import { fetchPaymentMethod } from '../../store/actions/users.action'
...
const CreateCampaign: React.FC = () => {
    ...
    const campaignInfo: any = useSelector((state: IStateType) => state.campaign.campaign);
    const mbtiLoader: any = useSelector((state: IStateType) => state.campaign.mbtiLoader);
    const roles: any = useSelector((state: IStateType) => state.campaign.roles);
    const path: IRootPageStateType = useSelector((state: IStateType) => state.root.page);
    const mbti: any = useSelector((state: IStateType) => state.campaign.mbti);
    const preferences: any = useSelector((state: IStateType) => state.campaign.preferences);
    const preSpendRatio: any = useSelector((state: IStateType) => state.campaign.preSpendRatio);
    const extraversionRed: any = useSelector((state: IStateType) => state.campaign.extraversion);
    const selectedCampaignID: any = useSelector((state: IStateType) => state.campaign.id);
    const creditCard: any = useSelector((state: IStateType) => state.users.paymentMethod.cardNumber)
    ...
    let cid = location && location.pathname && location.pathname.split('/')[2]
    ...
    const update = () => {
        ...
        history.push(`/CreateCampaign/${selectedCampaignID}`)
    }
    ...
    const goBack = () => { history.push('/campaign-dashboard') }
