import { ICustServiceState, IActionBase } from "../../models/root.interface";
import {
    ADD_ADMIN,
    REMOVE_ADMIN,
    SET_LOADER_USERS,
    ...
    SET_INVOICES
} from "../../actions/CustService/custService.action";

const initialState: ICustServiceState = {
    users: [
...
function custServiceReducer(state: ICustServiceState = initialState, action: IActionBase): ICustServiceState {
    switch (action.type) {
        case ADD_ADMIN: {
...
export default custServiceReducer;